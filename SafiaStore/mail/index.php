...
if(isset($_SESSION['account_email_register'])){
    ...
    $mail->SMTPSecure = 'ssl';
    $mail->isHTML(true);
    $mail->setFrom("quocnguyen.120301@gmail.com", "ROSA STORE");
    $mail->addAddress($email);
    $mail->Subject = ("ROSA STORE Authenticate accounts");  
    ...
    <div style="font-family:Roboto-Regular,Helvetica,Arial,sans-serif;font-size:14px;color:rgba(0,0,0,0.87);line-height:20px;padding-top:20px;text-align:left">
      SAFIA STORE đã nhận được yêu cầu sử dụng <a style="font-weight:bold">Email của bạn </a> làm tên tài khoản đăng nhập ROSA STORE <br><br>
