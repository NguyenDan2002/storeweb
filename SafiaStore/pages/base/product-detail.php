            ...
            <div class="row">
                    ...
                    <div class="product-detail__media">
                        <div class="media__items d-flex">
                            <div class="media__item product-image-container w-100">
                                <img class="w-100"
                                    src="admin/modules/product/uploads/<?php echo $row_product_detail['product_image'] ?>"
                                    alt="image product" />
                ...
                <div class="col" style="--w-md: 6">
                    <div class="product-detail__info">
                        <form method="POST"
                            action="pages/handle/addtocart.php?product_id=<?php echo $row_product_detail['product_id'] ?>">
                            ...
                            <div class="product-detail__price d-flex align-center">
                                <?php
                                    ...
                                    ?>
                                <del
                                    class="product__price--old h5"><?php echo number_format($row_product_detail['product_price']) . ' ₫' ?></del>
                                <?php
                                    }
                                    ?>

                                <span
                                    class="product__price--new h4"><?php echo (number_format($row_product_detail['product_price'] - ($row_product_detail['product_price'] / 100 * $row_product_detail['product_sale']))) . ' ₫' ?></span>
                                <?php
                                    if ($row_product_detail['product_sale'] > 0) {
                                    ?>
                                <span class="product__sale h6"> -
                                    <?php echo $row_product_detail['product_sale'] ?>%</span>
                                <?php
                                    }
                                    ?>
                            </div>
                            <span class="h5 product-code">Mã sản phẩm:
                                <?php echo $row_product_detail['product_id'] ?></span>
                            ...
                            <div class="select_order d-flex">
                                <div class="product-detail__quantity">
                                    ...
                                    <div class="d-flex align-center">
                                        <div class="select__number p-relative">
                                            ...
                                            <input type="text" name="product_quantity" min="1" value="1" readonly
                                                class="select__number--value heading-6 w-100 h-100" />
                                            <button type="button" class="select__number--plus cursor-pointer p-absolute"
                                ...
                                <div class="product-detail__quantity">
                                    <h3 class="quantity__heading h5">Size</h3>
                                    <div class="d-flex align-center">
                                        <div class="select__option p-relative">
                                            <select name="product_scent" id="product_scent">
                                                <?php 
                                                    ...
                                                    ?>
                                                <option value="<?php echo $scent['variant_id'] ?>">
                                                    <?php echo $scent['variant_name'] ?></option>
                                                <?php
                                                    }
                                                    ?>
                                            </select>
                                        ...
                                        <span class="h6"
                                            style="margin-left: 10px;"><?php if ($row_product_detail['product_quantity'] > 0) { ?>
                                            còn <span class="quantity-total">
                                                <?php echo $row_product_detail['product_quantity'] ?> </span> sản phẩm
                                            <?php } else { ?>Hiện sản phẩm đã hết hàng<?php } ?></span>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="tab-pane">
                ...
                <div class="comment-form">
                    <form class="post-comment" method="POST"
                        action="pages/handle/evaluate_rating.php?product_id=<?php echo $product_id; ?>">
                        ...
                        <div class="form-element mg-t-20">
                            <textarea class="form-control" name="evaluate_content"
                                placeholder="Hãy cho chúng tôi biết đánh giá của bạn về sản phẩm này!"></textarea>
                        </div>
                        <div class="d-flex align-center">
                            <?php
                                if (isset($_SESSION['account_id'])) {
                                ?>
                            <button class="btn btn__solid mg-t-10" name="evaluate_add" type="submit">Gửi nhận
                                xét</button>
                            <?php
                                } else {
                                ?>
                ...
                <div class="evaluate__content">
                    ...
                    <div class="comment-item d-flex">
                        <div class="f-cmuser"><abbr
                                title="Thịnh Đặng"><?php echo substr($evaluate['account_name'], 0, 1) ?></abbr></div>
