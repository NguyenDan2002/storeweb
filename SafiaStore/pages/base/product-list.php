...
<div class="product-list">
    <div class="container pd-section">
        ...
        <div class="row" id="or">
            ...
            ?>
            <div class="col" style="--w: 6; --w-md: 3; border: 2px solid gray; background-color: orange; ">
                <div class="product__card d-flex flex-column box_size " style="background-color: orange">
