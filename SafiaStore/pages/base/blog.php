                    ...
                    <a href="index.php?page=article&article_id=<?php echo $row['article_id'] ?>">
                        <div class="blog__image">
                            <img class="w-100 h-100 d-block object-fit-cover"
                                src="admin/modules/blog/uploads/<?php echo $row['article_image'] ?>" alt="" />
                        </div>
                        <div class="blog__content" style="background-color: orange;">
                            <h3 class="blog__title h3">
                                <?php echo $row['article_title'] ?>
                            </h3>
                            <span class="blog__date h6 d-block"><?php echo $row['article_date'] ?> -
                                <?php echo $row['article_author'] ?></span>
