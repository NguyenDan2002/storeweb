        ...
        <div class="customer-feedback">
            <ul class="customer-feedback__items d-flex w-100" tabindex="0"
                ...
                while ($row = mysqli_fetch_array($query_article_list)) {
                    $i++;
                ?>
                <li class="customer-feedback__item justify-center align-center" style="width:50%"
                    id="new-<?php echo $row['article_id'] ?>">
                    <div class="customer-feedback__image w-100">
                        <a href="index.php?page=article&article_id=<?php echo $row['article_id'] ?>"><img
                                class="image-news w-100 h-100 d-block object-fit-cover"
                                src="admin/modules/blog/uploads/<?php echo $row['article_image'] ?>"
                                alt="customer1"></a>
                    </div>
                    <div class="customer-feedback__content w-100 h-100 d-flex"
                        style="background-color:orange;height: 220px;margin-bottom: 10px;">
                        ...
                        <p class="customer-feedback__text h4">
                            <?php echo mb_strimwidth($row['article_summary'], 0, 200, "...") ?></p>
                    </div>
                </li>
                <?php
                }
