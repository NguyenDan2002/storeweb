                ...
                <div class="main-pane-top d-flex justify-center align-center">
                    <div class="input__search p-relative">
                        <form class="search-form" action="?action=product&query=product_search" method="POST">
                            ...
                            <input type="search" class="form-control" name="product_search" placeholder="Search Here"
                                title="Search here">
                        </form>
                    </div>
                </div>
                    ...
                    <table class="table table-hover table-action">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="<?php echo format_quantity_style($row['product_quantity']) ?>">
...
<div class="dialog__control">
    <div class="control__box">
        <a href="#" class="button__control btn__wanning"
            onclick="return confirm('Bạn có thực sự muốn xóa sản phẩm này không?')" id="btnDelete">Xóa</a>
