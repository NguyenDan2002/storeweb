                    ...
                    <div class="checkout">
                        <div class="row">
                            <div class="col col-lg-7">
                                <div class="checkout__title d-flex align-center space-between"><span>Mã đơn hàng:
                                        <?php echo $order_code; ?></span> <span>Thời gian:
                                        <?php echo $order_date ?></span></div>
                                ...
                                <div class="checkout__infomation">
                                    ...
                                    <div class="info__item d-flex">
                                        ...
                                        <input type="text" class="info__input flex-1" name="order_type"
                                            value="<?php echo format_order_type($account['order_type']) ?>"></input>
                                    </div>
                                    <?php
                                    }
                                    ?>
                            ...
                            <div class="col col-lg-5">
                                <div class="checkout__cart">
                                    <div class="checkout__items">
                                        ...
                                        <div class="checkout__item d-flex align-center">
                                            <div class="checkout__image p-relative">
                                                <div
                                                    class="product-quantity align-center d-flex justify-center p-absolute">
                                                    <span
                                                        class="quantity-number"><?php echo $cart_item['product_quantity'] ?></span>
                                                </div>
                                    ...
                                    <div class="checkout__bottom d-flex align-center space-between">
                                        ...
                                        <span
                                            class="checkout__total"><?php echo number_format((float) $total) . '₫' ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="d-flex algin-center space-between">
                            ...
                            <div class="order__detail--action">
                                ...
                                <a href="modules/order/xuly.php?confirm=1&order_code=<?php echo $order_code ?>"
                                    class="btn btn-outline-dark btn-fw">Duyệt đơn</a>
                                <?php
                                    } else {
                                    ?>
                                <a href="modules/order/xuly.php?rollback=1&order_code=<?php echo $order_code ?>"
                                    class="btn btn-outline-dark btn-fw">Trả hàng</a>
                                <?php
                                    }
                                    ?>
                                <a href="modules/order/indonhang.php?order_code=<?php echo $order_code ?>"
                                    target="_blank" class="btn btn-outline-dark btn-fw mg-l-16">In Hóa Đơn</a>
                            </div>

                            <div class="order_status">Tình trạng đơn: <span
                                    class="col-span"><?php echo format_order_status($status['order_status']); ?></span>
                            </div>
                            <?php
                            }
                            ?>
...
<script>
window.history.pushState(null, "", "index.php?action=order&query=order_detail_online&order_code=" +
    "<?php echo $order_code ?>");
</script>